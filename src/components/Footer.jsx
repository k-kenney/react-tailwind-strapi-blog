    ...
    <div className="w-full bg-[#02044a] text-gray-300 py-8 px-2">
      <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8'">
        ...
        <div className="col-span-2 pt-2 md:pt-2">
          <p className="font-bold uppercase">Subscripe to Out Newsletter</p>
          <p className="py-4">Lorem ipsum, dolor sit amet consectetur ipsum, dolor sit amet consectetur</p>
          <form className="flex flex-col sm:flex-row">
            <input className="w-full p-2 mr-4 rounded-md mb-2" type="email" placeholder="example@gmail.com" />
      ...
      <div className="flex flex-col max-w-[1240px] px-2 py-4 m-auto justify-between sm:flex-row text-center text-gray-500 items-center">
        <p>2023 KK, LLC. All rights reserved.</p>
