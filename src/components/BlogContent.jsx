...
const BlogContent = ({ blogs }) => {
  ...
  //     "id": 1,
  //     "title": 'Blog 1',
  //     "desc": "Lorem ipsum dolor sit amet consectetur adipisicing elit. At illum animi quidem numquam pariatur dolor architecto voluptatem est et non, fugiat earum magnam dignissimos quae nostrum dicta optio beatae? Iste.",
  //     "coverImg": 'https://neilpatel.com/wp-content/uploads/2017/09/blog-post-image-guide.jpg',
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 ss:grid-cols-1
         md:gap-8 sm:gap-y-8 ss:gap-y-8 px-4 sm:pt-20 md:mt-0 ss: pt-20 text-black">
          ...
          <div className="w-full bg-white rounded-xl overflow-hidden drop-shadow-md py-5 max-h-[250px]">
            <div>
              <img className='p-2 w-32 h-32 rounded-full mx-auto object-cover' src={`http://localhost:1337${blog.attributes.authorImg.data.attributes.url}`} alt="developer photo" />
  ...
  //         <div className="w-full bg-white rounded-xl overflow-hidden drop-shadow-md py-5 max-h-[250px]">
  //           <div>
  //             <img className='p-2 w-32 h-32 rounded-full mx-auto object-cover' src={blog.authorImg} alt="developer photo" />
